...
// 	// attestation.Options --> is parsed to custom defined attestationOptions
// 	attestationOptions, err := ParseAttestationOptions(attestation.Options)
// 	require.NoError(t, err)
// 	require.NotNil(t, attestationOptions)

// 	// Ensure that the mock credential isn't excluded by the attestation options
// 	isExcluded := cred.IsExcludedForAttestation(*attestationOptions) // custom defined object
...
// 	attestationResponse := CreateAttestationResponse(rp, authenticator, cred, *attestationOptions)
...
// 	// Parses the attestation options we got from the relying party to ensure they're valid
// 	assertionOptions, err := ParseAssertionOptions(assertion.Options)
// 	require.NoError(t, err)
...
// // returns a WebauthnAttestation object (custom defined)
